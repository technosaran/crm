            ...
            <div className="bg-white border border-sf-border rounded-[4px] p-4 shadow-sm">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="bg-[#f2672a] h-10 w-10 shadow-lg rounded-full flex items-center justify-center text-white">
                            <LayoutGrid size={20} />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex border border-sf-border rounded-[4px] bg-white overflow-hidden mr-2">
                        ...
                        <button className="sf-btn-neutral" onClick={() => setShowFilters(!showFilters)}>
                        ...
                        <div className="flex items-center gap-3 text-[12px] text-slate-500 font-bold">
                            {selectedIds.length > 0 ? (
                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-3">
                                    ...
                                    <button onClick={handleDelete} className="text-red-600 hover:underline">Delete Selected</button>
                                    <button className="text-sf-blue hover:underline">Mass Update</button>
                                </motion.div>
                            ) : (
